...
-- 店舗(shop)テーブル作成
CREATE TABLE `reserve`.`shop` ( `id` INT NOT NULL AUTO_INCREMENT , `login_id` VARCHAR(20) NOT NULL , `login_password` VARCHAR(20) NOT NULL , `reservable_date` INT NOT NULL , `start_time` TIME NOT NULL , `end_time` TIME NOT NULL , `max_reserve_num` INT NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
